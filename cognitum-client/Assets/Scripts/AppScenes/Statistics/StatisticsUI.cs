...
public class StatisticsUI : MonoBehaviour
{
  ...
  void OnShowStatisticsClicked()
  {
    ...
    {
      _graphContainer.SetActive(false);
      _text.text = "ƒанных за выбранный период нет.";
    }
    else
    {
      _text.text = "—реднее значение рассчитываетс€ по всем сыгранным сесси€м в пределах указанного периода.";
  ...
  private IEnumerator AnimateLoadingText()
  {
    ...
    string baseText = "ƒанные обновл€ютс€ ";
    int dotCount = 0;
